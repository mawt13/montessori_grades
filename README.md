...
```sh
git clone https://github.com/nickjj/docker-rails-example montessori_grades
cd montessori_grades
...
The app is named `montessori_grades` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "montessori_grades" and update a few Docker related resources.
